...
# 修改IP(C类地址)和主机名
sed -i 's/192.168.6.1/192.168.66.254/g' package/base-files/files/bin/config_generate
...
sed -i '/^TARGET_DEVICES += h3c_magic-nx30-pro-nmbm$/a\
\
define Device/h3c_magic-nx30-pro-nmbm-112m\
  DEVICE_VENDOR := H3C\
  DEVICE_MODEL := Magic NX30 Pro\
  DEVICE_VARIANT := (NMBM 112m layout)\
  DEVICE_DTS := mt7981b-h3c-magic-nx30-pro-nmbm-112m\
  DEVICE_DTS_DIR := ../dts\
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware\
  SUPPORTED_DEVICES += h3c,magic-nx30-pro-nmbm\
  UBINIZE_OPTS := -E 5\
  BLOCKSIZE := 128k\
  PAGESIZE := 2048\
  IMAGE_SIZE := 114688k\
